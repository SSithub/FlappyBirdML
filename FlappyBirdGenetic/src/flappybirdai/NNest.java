...
public class NNest extends Application implements Serializable{
    ...
    public class NN implements Serializable{
        ...
        public void mutateAdditive(double mutateRate, double range){//Can't use the random class because copied networks will have the same random class with the same random numbers
            for (int i = 0; i < getNetworkSize(); i++) {
        ...
        public void setOptimizer(String optimizer){
            if("".equals(optimizer))
                this.updater = (a,b) -> (c,d) -> {return new float[][][]{scale(a,b)};};
